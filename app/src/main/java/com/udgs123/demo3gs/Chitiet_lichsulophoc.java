...
public class Chitiet_lichsulophoc extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_lichsulophoc);
        ...
        try {
            ...
            if(connect==null){
                ...
                if (rs.next()){
                    if (rs.getInt( "Trangthailop" )==3){
                        trangthailop.setTextColor( Color.RED);
                        trangthailop.setText("Đã hoàn tất khóa học");
                    }
