...
public class Lopchonhan {
    private String Malophoc, Tentaikhoanhv, Caplop, Tenmonhoc, Diadiem, Ngaydukien, Soluonggio, Ngayhoctrongtuan, Giobatdau, Loaitrinhdo, Mota, Ngaytao, Trangthailop, Tentaikhoangs, Hocphi;

    public Lopchonhan(String malophoc, String tentaikhoanhv, String caplop, String tenmonhoc, String diadiem, String ngaydukien, String soluonggio, String ngayhoctrongtuan, String giobatdau, String loaitrinhdo, String mota, String ngaytao, String trangthailop, String tentaikhoangs, String hocphi) {
        Malophoc = malophoc;
