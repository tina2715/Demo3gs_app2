...
import com.udgs123.demo3gs.Chitiet_lopchonhan;
...
public class LopchonhanFragment extends Fragment {
    ...
    View v;
    Connection connect;
    ArrayList<Lopchonhan> lopchonhans;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        recyclerView = v.findViewById(R.id.lopchonhan_recyclerview);
        lopchonhans = new ArrayList<>();
        malophoc.clear();
        tentaikhoanhv.clear();
        caplop.clear();
        tenmonhoc.clear();
        ...
        try {
            ...
            if (connect==null) {
                ...
                String query = "SELECT * FROM Quanlylop Where Trangthailop=1 AND Tentaikhoangs='"+tentaikhoan+"'";
                ...
                for (int i = 0; i < caplop.size(); i++) {
                    lopchonhans.add(new Lopchonhan(malophocArr[i],tentaikhoanhvArr[i],caplopArr[i],tenmonhocArr[i],diadiemArr[i],ngaydukienArr[i],soluonggioArr[i],ngayhoctrongtuanArr[i],giobatdauArr[i],loaitrinhdoArr[i],motaArr[i],ngaytaoArr[i],trangthailopArr[i],tentaikhoangsArr[i],hocphiArr[i]));
                }
                connect.close();
            }
        } catch (Exception e)
        ...
        recyclerViewAdapter = new RecyclerViewAdapter(lopchonhans);
        ...
        if (recyclerView.getAdapter()!=null){
            ((RecyclerViewAdapter) recyclerView.getAdapter()).setOnItemClickListener( new OnItemClickListener() {
                ...
                public void onClick(View v, @NonNull int position) {
                    ...
                    Intent detail = new Intent(getActivity(), Chitiet_lopchonhan.class );
