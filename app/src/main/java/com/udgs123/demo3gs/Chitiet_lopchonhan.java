...
public class Chitiet_lopchonhan extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.dialog_lopchonhan );
        ...
        try {
            ...
            if(connect==null){
                ...
                if (rs.next()){
                    if (rs.getInt( "Trangthailop" )==1){
                        trangthailop.setTextColor(Color.BLUE);
                        trangthailop.setText("Đang chờ duyệt");
                    }
